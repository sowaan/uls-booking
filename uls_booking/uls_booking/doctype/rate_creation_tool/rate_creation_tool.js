...
frappe.ui.form.on("Rate Creation Tool", {
    ...
    //     await frm.events.create_rate(frm, frm.doc.select_rate_type);
    // },
    ...
    //             frappe.msgprint("Enter Full Tariff");
    //         }
    //         else if( !frm.doc.select_rate_type )
    //         {
    //             frappe.msgprint("Select Rate type");
    //         }        
    //         else if ( !frm.doc.weight_slab || !frm.doc.weight_slab.length )
    //         {
    //             frappe.msgprint("Enter Values in Weight Slab Table");
    //         } 
    //         else if(frm.doc.service_type && frm.doc.full_tariff && frm.doc.select_rate_type && frm.doc.weight_slab.length )
    //         {                        
    ...
    //                                 exist : r.message,
    //                                 rate_type : rate_type,
    //                                 rate_grp : frm.doc.selling_rate_group ,
    //                                 rate_creation_tool : frm.doc.name ,
    //                             },
    //                             freeze : true ,
    //                             // async: false,
    //                             callback: function (r) {
    ...
    //                                     exist : r.message,
    //                                     rate_type : rate_type,
    //                                     rate_grp : frm.doc.buying_rate_group ,
    //                                     rate_creation_tool : frm.doc.name ,
    //                                 },
    //                                 freeze : true ,
    //                                 // async: false,
    ...
    service_type: async function(frm) {
        if (frm.doc.service_type) {
            ...
            frm.set_value('selling_rate_group',null);
            await frappe.call({
                method: "uls_booking.uls_booking.api.api.get_selling_rate_group",
                args: {
                    service_type : frm.doc.service_type,
                },
                async: false,
                callback: function (r) {
                    if (r.message) {
                        frm.set_query("selling_rate_group", function () {
                            return {
                              filters: [["Selling Rate Group", "name", "in", r.message]],
                            };
                          });
                    }
                },
            ...
            frm.set_value('buying_rate_group',null);
            await frappe.call({
                method: "uls_booking.uls_booking.api.api.get_buying_rate_group",
                args: {
                    service_type : frm.doc.service_type,
                },
                async: false,
                callback: function (r) {
                    if (r.message) {
                        console.log(r.message); 
                        frm.set_query("buying_rate_group", function () {
                            return {
                              filters: [["Buying Rate Group", "name", "in", r.message]],
                            };
                          });
                    }
                },
            ...
            frm.set_value('select_rate_type',null);
            frm.set_value('selling_rate_group',null);
            frm.set_value('buying_rate_group',null);
