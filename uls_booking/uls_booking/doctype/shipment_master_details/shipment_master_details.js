        ...
        frm.add_custom_button('Get Records', function () {
            ...
            frappe.call({
                ...
                callback: function(response) {
                    ...
                    if (frm.doc.customer_shipper) {
                        customer_field = frm.doc.customer_shipper;
                    }
                        ...
                        frm.fields_dict.dispute_invoice_number.grid.get_field("customers_sales_invoice").get_query = function () {
                            return {
                                filters: {
                                    ...
                                    custom_shipment_number: frm.doc.shipment_number
                                }
                            };
                        };
                        frm.fields_dict.dispute_invoice_number_billing.grid.get_field("customers_sales_invoice").get_query = function () {
                            return {
                                filters: {
                                    customer: customer_field,
                                    custom_shipment_number: frm.doc.shipment_number
...
//             frm.set_value('dws_actual', r6_record.dws_actual_weight || '');
