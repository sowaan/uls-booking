...
# class BookingInvoice(SalesInvoice) :
...
#         if self.custom_booking :
#             booking_doc = frappe.get_doc("Booking",self.custom_booking)
#             booking_doc.invoice_submitted = 1
#             booking_doc.save()
...
#         if self.custom_booking :
#             booking_doc = frappe.get_doc("Booking",self.custom_booking)
#             booking_doc.invoice_submitted = 0
#             booking_doc.save()        
